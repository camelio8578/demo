"""Sacramento County excess-proceeds scraper."""
...
class SacramentoScraper(BaseScraper):
    ...
    def parse(self, html: str, source_cfg: dict, source_url: str) -> list[dict]:
        """Parse Sacramento County HTML into raw lead dicts.

        Tries CSS selectors from config first; falls back to keyword matching.
        Sacramento County Tax Collector publishes defaulted tax sale results
        with APN, property address, sale date, and minimum bid / proceeds columns.
        """

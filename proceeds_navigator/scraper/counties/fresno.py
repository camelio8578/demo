"""Fresno County excess-proceeds scraper."""
...
class FresnoScraper(BaseScraper):
    county_key = "fresno"
    ...
    def parse(self, html: str, source_cfg: dict, source_url: str) -> list[dict]:
        """Parse Fresno County HTML into raw lead dicts.

        Tries CSS selectors from config first; falls back to keyword matching.
        Fresno publishes tax-defaulted property auction results with APN,
        address, sale date, and bid/proceeds amount columns.
        """
